...
/*
 * To define a secure interface, prepend '$' before the interface name, eg., "$org.alljoyn.print_test"
 */
static const char* const testInterface2[] = {
#ifdef SECURE_INTERFACE
    "$org.alljoyn.print_test",
#else
    "org.alljoyn.print_test",
#endif
    "?my_print inStr<s outStr>s",
    NULL
};
...
static const AJ_Object AppObjects[] = {
    ...
    { "/org/alljoyn/print_test", testInterfaces2 },
    { NULL }
};
...
#define APP_MY_PRINT         AJ_APP_MESSAGE_ID(1, 1, 0)
 ...
 */
static AJ_Status AppHandlePrint(AJ_Message* msg)
{
    AJ_Message reply;
    AJ_Arg arg;
