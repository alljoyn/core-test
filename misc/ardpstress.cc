...
static void usage() {
    ...
    printf(" -f :  Use only when running ardpfuzz in conjunction with ardpstress \n");
}
...
int main(int argc, char** argv)
{
    ...
    ardpConfig.delayedAckTimeout = UDP_DELAYED_ACK_TIMEOUT;
